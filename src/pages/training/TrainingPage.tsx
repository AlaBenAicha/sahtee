        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-slate-500 mt-2 max-w-md">
              Le module de formation sera disponible dans une prochaine version.
              Vous pourrez planifier des sessions et suivre les certifications.
            </p>
          </div>
        </CardContent>
      </Card>

...
export function PlatformPreview({ dashboardImage }: PlatformPreviewProps) {
  ...
  const modules = [
    ...
    {
      icon: Target,
      title: "Plans d'action préventifs & correctifs (CAPA Room)",
      description:
        "Centre unifié de gestion des actions correctives et préventives. Hiérarchise les plans par priorité avec interface Kanban. Intègre les recommandations de formation et SST. Cartographie et suit les actions par cases cochées, facilitant la planification, l'attribution et la mesure de l'efficacité.",
      features: [
        "Interface Kanban",
        "Formation intégrée",
        "Suivi temps réel",
    ...
    {
      icon: GraduationCap,
      title: "Formation continue (intégrée dans CAPA Room)",
      description:
        "Module de formation accessible via CAPA Room. Plateforme LMS avec vidéos interactives, quiz adaptatifs, certifications numériques et suivi des compétences. Les besoins de formation sont automatiquement liés aux actions correctives et préventives.",
      features: [
        "Accessible via CAPA",
        "Vidéos & Quiz",
        "Certifications",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explorez nos modules interconnectés pour une gestion complète de la
            SST
          </p>
        </div>

            ...
            <div className="relative z-10 text-center">
              ...
              <div className="mt-6 pt-5 border-t border-slate-100">
                <p className="text-xs text-slate-400 mb-3">
                  {mode === "agent" ? "Essayez par exemple :" : "Questions populaires :"}
                </p>
                <div className="space-y-2">
                  {mode === "agent" ? (
                    <>
                      <ExamplePrompt text="Va sur la page des incidents" mode={mode} />
                      <ExamplePrompt text="Crée une nouvelle CAPA" mode={mode} />
                    </>
                  ) : (
                    <>
                      <ExamplePrompt text="Quelles sont les obligations EPI ?" mode={mode} />
                      <ExamplePrompt text="Comment déclarer un incident ?" mode={mode} />
                    </>
                  )}
                </div>
              </div>
